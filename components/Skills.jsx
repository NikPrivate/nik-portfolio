    ...
    <div className="font-sans px-4 lg:px-0">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-4 justify-center">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="flex flex-col items-center space-y-2 p-2 shadow-lg rounded-md bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all "
          >
            <Image
              src={skill.image}
              alt={skill.title}
